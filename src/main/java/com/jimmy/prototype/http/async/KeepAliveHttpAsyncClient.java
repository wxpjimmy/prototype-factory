 ...
 */
public class KeepAliveHttpAsyncClient {
    private static Logger logger = LoggerFactory.getLogger(KeepAliveHttpAsyncClient.class);
    private CloseableHttpAsyncClient httpClient;

    static class AsyncPosterHolder {
        private final static KeepAliveHttpAsyncClient INSTANCE = new KeepAliveHttpAsyncClient();
    }

    public static KeepAliveHttpAsyncClient getInstance() {
        return AsyncPosterHolder.INSTANCE;
    }

    private KeepAliveHttpAsyncClient() {
